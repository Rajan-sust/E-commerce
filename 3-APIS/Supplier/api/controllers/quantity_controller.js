...
function quantity(req, res) {
    ...
    console.log('printing params ',req.swagger.params.id.value);
    res.json(1);
   ...
   /* var bankInfo = JSON.stringify(req.swagger.params.bankInfo);
    ...
    console.log(accountno, secret);

    var queryStmt = `select balance from members where accountno = '${accountno}' and secret = '${secret}'`;
